...
/**
 * Servlet implementation class MainAdvisorServlet
 */
@WebServlet("/MainAdvisorServlet")
public class MainAdvisorServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
	public static final String VIEW = "/WEB-INF/Views/advisor/mainadvisor.jsp";
    
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MainAdvisorServlet() {
        super();
